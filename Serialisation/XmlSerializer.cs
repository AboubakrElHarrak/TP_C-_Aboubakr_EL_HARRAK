...
namespace ContactManager.Serialisation
{
    public class XmlSerializer : ISerializer
    {
        ...
        public Folder Deserialize(string fileName, Folder root, out bool exceptionHandled)
        {
            ...
            {
                Helper.PrintError("Il y a un probleme avec le processus de serialisation, Merci de verifier le format du fichier ou bien la cle avant de reessayer ! <SerializationException>");
                exceptionHandled = true;
                return root;
            }
            catch (InvalidOperationException)
            {
                Helper.PrintError("Il y a un probleme avec le processus de serialisation, Merci de verifier le format du fichier ou bien la cle avant de reessayer ! <InvalidOperationException>");
                exceptionHandled = true;
                return root;
            }
        }
